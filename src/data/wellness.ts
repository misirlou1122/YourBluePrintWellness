    ...
    groups: [
      {
        ...
        fields: ["Water tracker", "Meal tracker", "Manual nutrition", "Protein", "Fiber", "Calories", "Mood", "Medication", "Workout", "Alcohol"]
      }
    ]
  },
  {
    ...
    groups: [
      {
        ...
        fields: ["Water tracker", "Meal tracker", "Manual nutrition", "Protein", "Fiber", "Calories"]
      },
      {
