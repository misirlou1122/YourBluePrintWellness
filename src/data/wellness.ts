...
export const wellnessTiles: WellnessTile[] = [
  ...
  },
  {
    ...
    icon: "dumbbell",
    subcategories: ["Calories burned", "Cardio", "Strength machines", "Treadmill", "Swimming", "Pilates", "Yoga", "Sauna", "Steam room", "Tanning", "Recovery"],
    groups: [
      {
        title: "What I Want To Do",
        description: "Choose from supportive movement categories.",
        checklist: ["Treadmill", "Swimming", "Strength machines", "Pilates", "Yoga", "Stretching", "Sauna", "Steam room", "Tanning", "Recovery day"]
      },
      {
        title: "What I Did Today",
        description: "Select completed movement and estimate calories burned.",
        fields: ["Cardio", "Strength machines", "Sauna / steam room / tanning", "Calories burned", "Duration", "Status", "Notes"]
      },
      {
        title: "Treadmill",
