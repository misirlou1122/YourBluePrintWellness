    ...
    >
      <div className="flex h-full flex-col justify-between gap-2 sm:gap-5">
        <div className="flex items-start justify-between gap-2 sm:gap-3">
          ...
          <span className="grid size-7 place-items-center rounded-full border border-white/10 bg-white/[0.06] text-ice/85 transition group-hover:text-white sm:size-9">
